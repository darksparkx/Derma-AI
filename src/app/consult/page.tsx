				...
				>
					<div className="container mx-auto">
						...
						<p className="text-xl leading-relaxed mb-8">
							...
							Schedule a free immediate consultation by uploading
							a picture. Our advanced AI technology will analyze
							your skin and provide us with useful insights.
							It&apos;s quick, easy, and the first step to a more
							radiant you.
						</p>
